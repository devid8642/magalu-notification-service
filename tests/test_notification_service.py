...
@pytest.mark.asyncio
async def test_create_notification(send_notification_data: SendNotificationSchema, notification: Notification):
    ...
    created_notification = await service.create_notification(send_notification_data)

    mock_repo.create_notification.assert_called_once_with(send_notification_data)
